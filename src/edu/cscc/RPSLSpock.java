...
public class RPSLSpock {
     ...
     *
     * @param pick
     * @return ignore case sensitive of pick
     */
    ...
    /**
     * Generating random computer picks
     *
     * @return picks
     */
    ...
    /**
     * Setting eaching variable to know which one beats which
     *
     * @param c_pick computer picks
     * @param h_pick user picks
     * @return the winner
     */
